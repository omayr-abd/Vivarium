 ...
 * 
 * PA3.java
 * In this Programming Assignment I create a shark (predator) that chases a fish (prey) around the tank.
 * I also implement food that both the shark and the fish can eat, but only the fish chases after.
 * 
 */
...
private GLUT glut;
  ...
  public PA3()
  {
    ...
    setTitle("CS480/CS680 : Shark Tank");
   ...
   * KeyListener
   * 
   * F/f: Create a ball of food inside the tank
   * N/n: Reset the fish. This can either bring a live fish to the middle of the tank, or create a new one after a fish has died
   * Q/q: Quit the program
   * R/r: Reset the viewing quaternion
   * 
   */
